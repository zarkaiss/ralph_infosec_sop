...
if '..' in content:
    ...
    if matches:
        issues.append("Double dots found")
...
print("RFC2119 issues:", ", ".join(rfc_issues) if rfc_issues_ else "None")
...
print("RFC2119 keyword counts:")  
print("MUST:", must_count)
