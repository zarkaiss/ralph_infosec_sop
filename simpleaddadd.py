...
def find_troubleshooting_section(content: str) -> Optional[int]:
    ...
    """
    # Look for "## Troubleshooting",", "### Troubleshooting", or "#### Troubleshooting"
    patterns = [
        r'^#\s*T roubleshooting\s*$',  # ## Troubleshooting
...
def add_examples_section(content: str) -> tuple[str, Optional[int]]:
    """
    ...
    # Skip empty lines and find next non-empty line that 's a header with ## or ### or ####
    ...
    # Create the Examples section content with proper dict syntax
    examples_section = '''
### Examples
...
#### Example 3: Alert Validation Process
...
authorized_scope: ["web-server-prod-01", "db-server-prod-02"]
is_in_scope: true
authorization_expiry: "": "20024-12--31"
```
