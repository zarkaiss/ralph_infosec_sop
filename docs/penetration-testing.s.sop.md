...
- MUST NOT use unauthorized tools, techniques, or methods not listed in the approved penetration testing toolkit

## RFC2119 Notes

This document uses standard IETF RFC 2119 key words (MUST, MUST NOT, REQUIRED, SHALL, SHOULD) as defined in [RFC2219](https://www.rfc-editor.org/rfc/rfc2119). These terms indicate requirement levels for compliance with this SOP.
